...
ALTER TABLE
    "BranchReport" DROP CONSTRAINT "BranchReport_branchId_fkey";

-- DropForeignKey

ALTER TABLE
    "BranchReport" DROP CONSTRAINT "BranchReport_reportId_fkey";
...
ALTER TABLE
    "ClientReport" DROP CONSTRAINT "ClientReport_clientId_fkey";

-- DropForeignKey

ALTER TABLE
    "ClientReport" DROP CONSTRAINT "ClientReport_reportId_fkey";

-- DropForeignKey

ALTER TABLE
    "ClientReport" DROP CONSTRAINT "ClientReport_storeId_fkey";

-- DropForeignKey

ALTER TABLE
    "DeliveryAgentReport" DROP CONSTRAINT "DeliveryAgentReport_deliveryAgentId_fkey";

-- DropForeignKey

ALTER TABLE
    "DeliveryAgentReport" DROP CONSTRAINT "DeliveryAgentReport_reportId_fkey";

-- DropForeignKey

ALTER TABLE
    "GovernorateReport" DROP CONSTRAINT "GovernorateReport_reportId_fkey";
...
ALTER TABLE
    "Notification" DROP CONSTRAINT "Notification_userId_fkey";
...
ALTER TABLE
    "OrderProducts" DROP CONSTRAINT "OrderProducts_colorId_fkey";

-- DropForeignKey

ALTER TABLE
    "OrderProducts" DROP CONSTRAINT "OrderProducts_orderId_fkey";

-- DropForeignKey

ALTER TABLE
    "OrderProducts" DROP CONSTRAINT "OrderProducts_productId_fkey";

-- DropForeignKey

ALTER TABLE
    "OrderProducts" DROP CONSTRAINT "OrderProducts_sizeId_fkey";
...
ALTER TABLE
    "ProductColors" DROP CONSTRAINT "ProductColors_colorId_fkey";

-- DropForeignKey

ALTER TABLE
    "ProductColors" DROP CONSTRAINT "ProductColors_productId_fkey";

-- DropForeignKey

ALTER TABLE
    "ProductSizes" DROP CONSTRAINT "ProductSizes_productId_fkey";

-- DropForeignKey

ALTER TABLE
    "ProductSizes" DROP CONSTRAINT "ProductSizes_sizeId_fkey";
...
ALTER TABLE
    "RepositoryReport" DROP CONSTRAINT "RepositoryReport_reportId_fkey";

-- DropForeignKey

ALTER TABLE
    "RepositoryReport" DROP CONSTRAINT "RepositoryReport_repositoryId_fkey";
...
ALTER TABLE
    "_LocationToUser" DROP CONSTRAINT "_LocationToUser_A_fkey";

-- DropForeignKey

ALTER TABLE
    "_LocationToUser" DROP CONSTRAINT "_LocationToUser_B_fkey";
...
ALTER TABLE
    "Banner" DROP CONSTRAINT "Banner_pkey",
ADD
    COLUMN "companyId" INTEGER NOT NULL,
    DROP COLUMN "id",
...
ALTER TABLE
    "Branch" DROP CONSTRAINT "Branch_pkey",
ADD
    COLUMN "companyId" INTEGER NOT NULL,
    DROP COLUMN "id",
ADD COLUMN "id" SERIAL NOT NULL,
...
ALTER TABLE
    "BranchReport" DROP COLUMN "branchId",
ADD
    COLUMN "branchId" INTEGER NOT NULL,
    DROP COLUMN "reportId",
ADD
    COLUMN "reportId" INTEGER NOT NULL;

-- AlterTable

ALTER TABLE
    "Category" DROP CONSTRAINT "Category_pkey",
ADD
    COLUMN "companyId" INTEGER NOT NULL,
    DROP COLUMN "id",
ADD COLUMN "id" SERIAL NOT NULL,
...
ALTER TABLE
    "Client" DROP CONSTRAINT "Client_pkey",
...
ADD
    COLUMN "companyId" INTEGER NOT NULL,
ADD
    COLUMN "employeeId" INTEGER NOT NULL,
ADD
    COLUMN "repositoryId" INTEGER,
ADD
    COLUMN "role" "ClientRole" NOT NULL,
    DROP COLUMN "id",
ADD
...
ALTER TABLE
    "ClientReport" DROP COLUMN "clientId",
ADD
    COLUMN "clientId" INTEGER NOT NULL,
    DROP COLUMN "reportId",
ADD
    COLUMN "reportId" INTEGER NOT NULL,
    DROP COLUMN "storeId",
...
ALTER TABLE
    "Color" DROP CONSTRAINT "Color_pkey",
ADD
    COLUMN "companyId" INTEGER NOT NULL,
    DROP COLUMN "id",
ADD COLUMN "id" SERIAL NOT NULL,
...
ALTER TABLE
    "DeliveryAgentReport" DROP COLUMN "deliveryAgentId",
ADD
    COLUMN "deliveryAgentId" INTEGER NOT NULL,
    DROP COLUMN "reportId",
ADD
    COLUMN "reportId" INTEGER NOT NULL;
...
ALTER TABLE
    "GovernorateReport" DROP COLUMN "reportId",
ADD
    COLUMN "reportId" INTEGER NOT NULL;
...
ALTER TABLE
    "Location" DROP CONSTRAINT "Location_pkey",
ADD
    COLUMN "companyId" INTEGER NOT NULL,
    DROP COLUMN "id",
ADD
...
ALTER TABLE
    "Notification" DROP CONSTRAINT "Notification_pkey",
    DROP COLUMN "id",
ADD
    COLUMN "id" SERIAL NOT NULL,
    DROP COLUMN "userId",
...
ALTER TABLE
    "Order" DROP CONSTRAINT "Order_pkey",
ADD
    COLUMN "companyId" INTEGER NOT NULL,
    DROP COLUMN "id",
ADD
...
ADD
    ...
    DROP COLUMN "storeId",
ADD
    COLUMN "storeId" INTEGER NOT NULL,
    DROP COLUMN "deliveryAgentId",
ADD
    COLUMN "deliveryAgentId" INTEGER,
ADD
...
ALTER TABLE
    "OrderProducts" DROP CONSTRAINT "OrderProducts_pkey",
    DROP COLUMN "productId",
ADD
    COLUMN "productId" INTEGER NOT NULL,
    DROP COLUMN "orderId",
ADD
    COLUMN "orderId" INTEGER NOT NULL,
    DROP COLUMN "colorId",
ADD
    COLUMN "colorId" INTEGER,
    DROP COLUMN "sizeId",
...
ALTER TABLE
    "ProductColors" DROP CONSTRAINT "ProductColors_pkey",
    DROP COLUMN "productId",
ADD
    COLUMN "productId" INTEGER NOT NULL,
    DROP COLUMN "colorId",
ADD
    COLUMN "colorId" INTEGER NOT NULL,
ADD
...
ALTER TABLE
    "ProductSizes" DROP CONSTRAINT "ProductSizes_pkey",
    DROP COLUMN "productId",
ADD
    COLUMN "productId" INTEGER NOT NULL,
    DROP COLUMN "sizeId",
ADD
    COLUMN "sizeId" INTEGER NOT NULL,
ADD
...
ALTER TABLE
    "Report" DROP CONSTRAINT "Report_pkey",
    DROP COLUMN "userId",
ADD
    COLUMN "companyId" INTEGER NOT NULL,
ADD
...
ALTER TABLE
    "Repository" DROP CONSTRAINT "Repository_pkey",
ADD
    COLUMN "companyId" INTEGER NOT NULL,
    DROP COLUMN "id",
ADD
...
ALTER TABLE
    "RepositoryReport" DROP COLUMN "repositoryId",
ADD
    COLUMN "repositoryId" INTEGER NOT NULL,
    DROP COLUMN "reportId",
ADD
    COLUMN "reportId" INTEGER NOT NULL;
...
ALTER TABLE
    "Size" DROP CONSTRAINT "Size_pkey",
ADD
    COLUMN "companyId" INTEGER NOT NULL,
    DROP COLUMN "id",
ADD COLUMN "id" SERIAL NOT NULL,
...
ALTER TABLE
    "Store" DROP CONSTRAINT "Store_pkey",
ADD
    COLUMN "companyId" INTEGER NOT NULL,
    DROP COLUMN "id",
ADD
...
CONSTRAINT "DeliveryAgentsLocations_pkey" PRIMARY KEY (
    "deliveryAgentId",
    "locationId"
)
);
...
ALTER TABLE "Employee"
ADD
    CONSTRAINT "Employee_repositoryId_fkey" FOREIGN KEY ("repositoryId") REFERENCES "Repository"("id") ON DELETE
...
ALTER TABLE "Employee"
ADD
    CONSTRAINT "Employee_branchId_fkey" FOREIGN KEY ("branchId") REFERENCES "Branch"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "Client"
ADD
    CONSTRAINT "Client_repositoryId_fkey" FOREIGN KEY ("repositoryId") REFERENCES "Repository"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
...
ADD
    CONSTRAINT "Repository_branchId_fkey" FOREIGN KEY ("branchId") REFERENCES "Branch"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE
    "DeliveryAgentsLocations"
ADD
    CONSTRAINT "DeliveryAgentsLocations_deliveryAgentId_fkey" FOREIGN KEY ("deliveryAgentId") REFERENCES "Employee"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE
    "DeliveryAgentsLocations"
ADD
    CONSTRAINT "DeliveryAgentsLocations_locationId_fkey" FOREIGN KEY ("locationId") REFERENCES "Location"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey

ALTER TABLE "Order"
ADD
    CONSTRAINT "Order_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "Client"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "Order"
ADD
    CONSTRAINT "Order_deliveryAgentId_fkey" FOREIGN KEY ("deliveryAgentId") REFERENCES "Employee"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "Order"
ADD
    CONSTRAINT "Order_locationId_fkey" FOREIGN KEY ("locationId") REFERENCES "Location"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
...
ADD
    CONSTRAINT "ClientReport_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "Client"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey

ALTER TABLE "ClientReport"
ADD
    CONSTRAINT "ClientReport_reportId_fkey" FOREIGN KEY ("reportId") REFERENCES "Report"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey

ALTER TABLE "ClientReport"
ADD
    CONSTRAINT "ClientReport_storeId_fkey" FOREIGN KEY ("storeId") REFERENCES "Store"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey

ALTER TABLE "RepositoryReport"
ADD
    CONSTRAINT "RepositoryReport_repositoryId_fkey" FOREIGN KEY ("repositoryId") REFERENCES "Repository"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey

ALTER TABLE "RepositoryReport"
ADD
    CONSTRAINT "RepositoryReport_reportId_fkey" FOREIGN KEY ("reportId") REFERENCES "Report"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey

ALTER TABLE "BranchReport"
ADD
    CONSTRAINT "BranchReport_branchId_fkey" FOREIGN KEY ("branchId") REFERENCES "Branch"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey

ALTER TABLE "BranchReport"
ADD
    CONSTRAINT "BranchReport_reportId_fkey" FOREIGN KEY ("reportId") REFERENCES "Report"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE
    "DeliveryAgentReport"
ADD
    CONSTRAINT "DeliveryAgentReport_deliveryAgentId_fkey" FOREIGN KEY ("deliveryAgentId") REFERENCES "Employee"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE
    "DeliveryAgentReport"
ADD
    CONSTRAINT "DeliveryAgentReport_reportId_fkey" FOREIGN KEY ("reportId") REFERENCES "Report"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE
    "GovernorateReport"
ADD
    CONSTRAINT "GovernorateReport_reportId_fkey" FOREIGN KEY ("reportId") REFERENCES "Report"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "OrderProducts"
ADD
    CONSTRAINT "OrderProducts_colorId_fkey" FOREIGN KEY ("colorId") REFERENCES "Color"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "OrderProducts"
ADD
    CONSTRAINT "OrderProducts_sizeId_fkey" FOREIGN KEY ("sizeId") REFERENCES "Size"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "Size"
ADD
    CONSTRAINT "Size_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ADD
    CONSTRAINT "ProductColors_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey

ALTER TABLE "ProductColors"
ADD
    CONSTRAINT "ProductColors_colorId_fkey" FOREIGN KEY ("colorId") REFERENCES "Color"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey

ALTER TABLE "ProductSizes"
ADD
    CONSTRAINT "ProductSizes_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey

ALTER TABLE "ProductSizes"
ADD
    CONSTRAINT "ProductSizes_sizeId_fkey" FOREIGN KEY ("sizeId") REFERENCES "Size"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "Banner"
ADD
    CONSTRAINT "Banner_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
